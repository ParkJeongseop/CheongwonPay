...
public class NetworkThread extends HandlerThread {
    ...
    public static final int OP_LOGIN = 1, OP_PURCHASE = 2, OP_ADD_ITEM = 3, OP_RF_BAL = 4, OP_GetGoodsList = 5, OP_GetRefundList = 6, OP_Refund = 7, OP_ATD = 10, OP_EditGoods = 11, OP_DeleteGoods = 12, OP_EditPW = 13, OP_GetName = 14, OP_UserMatching = 15;

    public static final String SERVER_IP = "cheongwonpay.parkjeongseop.com";
